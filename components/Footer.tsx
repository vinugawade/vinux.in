    ...
    <footer className="text-gray-600 dark:text-gray-400/50 w-screen font-inter mb-14 print:hidden">
      ...
      >
        ...
        >
          ...
          <Link target="_blank" aria-label="Next.js" rel="noreferrer" href="https://www.linkedin.com/in/vinu-gawade">
            <span className="font-light font-kalam">Vinay Gawade,</span>
            {/* <NextLogo /> */}
          </Link>
          <span>Original design by</span>
          <Link target="_blank" aria-label="Vercel" rel="noreferrer" href="https://j471n.in">
            <span className="font-light font-kalam">j471n.in</span>
            {/* <VercelLogo /> */}
          </Link>
        </motion.div>
      </motion.div>
